...
\begin{figure}[htbp]
\includegraphics[width=\textwidth,keepaspectratio]{images/pcb/pcb_decoupling.png}\caption{Okolí fázového závěsu a budiče v návrhovém prostředí KiCAD.}\label{pcb_decoupling}
\end{figure}
